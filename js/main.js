var now, firstshow, nextShow, nextMonday, showday, countdownTimer, everyMon;

firstshow = moment.tz("01/13/2020 18:30:00", "MM-DD-YYYY HH:mm:ss", "America/Los_Angeles");
nextShow = moment.tz("01/20/2020 18:30:00", "MM-DD-YYYY HH:mm:ss", "America/Los_Angeles");
...
} else if (myMoment.isAfter(firstshow.add(3, 'h'))) {
